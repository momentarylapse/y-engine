...
namespace vulkan{
	...
	struct ImageAndMemory {
		...
		VkImageView create_view(VkImageAspectFlags aspect_flags, VkImageViewType type, uint32_t mip_levels, uint32_t layer) const;
		void transition_layout(VkImageLayout old_layout, VkImageLayout new_layout, uint32_t mip_levels) const;
