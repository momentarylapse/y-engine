...
void SIAddPackageX()
{
	...
	TypeModelPListPs	= add_type_p(TypeModelPList, Flags::SILENT);
	...
	//	class_add_element("color",			TypeColor,		GetDAPicture(_color));
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Picture::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, x_p(mf(&Picture::__delete__)), Flags::OVERRIDE);
		class_add_func_virtual("__draw", TypeVoid, x_p(mf(&Picture::draw)), Flags::OVERRIDE);
		class_add_func_virtual("__update", TypeVoid, x_p(mf(&Picture::update)), Flags::OVERRIDE);
		_class_override_num_params = 1;
		class_add_func_virtual("on_iterate", TypeVoid, x_p(mf(&Picture::on_iterate)), Flags::OVERRIDE);
			func_add_param("dt", TypeFloat32);
		_class_override_num_params = 0;
		class_add_func_virtual("on_hover", TypeVoid, x_p(mf(&Picture::on_hover)), Flags::OVERRIDE);
		class_add_func_virtual("on_click", TypeVoid, x_p(mf(&Picture::on_click)), Flags::OVERRIDE);
		class_add_func_virtual("on_enter", TypeVoid, x_p(mf(&Picture::on_enter)), Flags::OVERRIDE);
		class_add_func_virtual("on_leave", TypeVoid, x_p(mf(&Picture::on_leave)), Flags::OVERRIDE);
		class_add_func_virtual("is_mouse_over", TypeBool, x_p(mf(&Picture::is_mouse_over)), Flags::OVERRIDE);
		_class_override_num_params = -1;
	...
	//	class_add_element("enabled",		TypeBool,		GetDAPicture3D(enabled));
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Picture3d::__init_ext__)));
			...
			func_add_param("z",			TypeFloat32);
		_class_override_num_params = 0;
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Picture3d::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, x_p(mf(&Picture3d::__delete__)), Flags::OVERRIDE);
		class_add_func_virtual("__draw", TypeVoid, x_p(mf(&Picture3d::draw)), Flags::OVERRIDE);
		class_add_func_virtual("__update", TypeVoid, x_p(mf(&Picture3d::update)), Flags::OVERRIDE);
		_class_override_num_params = 1;
		class_add_func_virtual("on_iterate", TypeVoid, x_p(mf(&Picture3d::on_iterate)), Flags::OVERRIDE);
			func_add_param("dt", TypeFloat32);
		_class_override_num_params = 0;
		class_add_func_virtual("on_hover", TypeVoid, x_p(mf(&Picture3d::on_hover)), Flags::OVERRIDE);
		class_add_func_virtual("on_click", TypeVoid, x_p(mf(&Picture3d::on_click)), Flags::OVERRIDE);
		class_add_func_virtual("on_enter", TypeVoid, x_p(mf(&Picture3d::on_enter)), Flags::OVERRIDE);
		class_add_func_virtual("on_leave", TypeVoid, x_p(mf(&Picture3d::on_leave)), Flags::OVERRIDE);
		class_add_func_virtual("is_mouse_over", TypeBool, x_p(mf(&Picture3d::is_mouse_over)), Flags::OVERRIDE);
		_class_override_num_params = -1;
	...
	//	class_add_element("color",			TypeColor,		GetDAText(_color));
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Text::__init_ext__)));
			...
			func_add_param("str",		TypeString);
			_class_override_num_params = 0;
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Text::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, x_p(mf(&Text::__delete__)), Flags::OVERRIDE);
		class_add_func_virtual("__draw", TypeVoid, x_p(mf(&Text::draw)), Flags::OVERRIDE);
		class_add_func_virtual("__update", TypeVoid, x_p(mf(&Text::update)), Flags::OVERRIDE);
		_class_override_num_params = 1;
		class_add_func_virtual("on_iterate", TypeVoid, x_p(mf(&Text::on_iterate)), Flags::OVERRIDE);
			func_add_param("dt", TypeFloat32);
		_class_override_num_params = 0;
		class_add_func_virtual("on_hover", TypeVoid, x_p(mf(&Text::on_hover)), Flags::OVERRIDE);
		class_add_func_virtual("on_click", TypeVoid, x_p(mf(&Text::on_click)), Flags::OVERRIDE);
		class_add_func_virtual("on_enter", TypeVoid, x_p(mf(&Text::on_enter)), Flags::OVERRIDE);
		class_add_func_virtual("on_leave", TypeVoid, x_p(mf(&Text::on_leave)), Flags::OVERRIDE);
		class_add_func_virtual("is_mouse_over", TypeBool, x_p(mf(&Text::is_mouse_over)), Flags::OVERRIDE);
	...
	add_class(TypeParticleRot);
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&ParticleRot::__init_ext__)));
			...
			func_add_param("radius", TypeFloat32);
		_class_override_num_params = 0;
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&ParticleRot::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, x_p(mf(&ParticleRot::__delete__)), Flags::OVERRIDE);
		_class_override_num_params = 1;
		class_add_func_virtual("on_iterate", TypeVoid, x_p(mf(&ParticleRot::on_iterate)), Flags::OVERRIDE);
			func_add_param("dt", TypeFloat32);
		_class_override_num_params = -1;
	...
	add_class(TypeBeam);
		...
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Beam::__init_ext__)));
			...
			func_add_param("radius", TypeFloat32);
		_class_override_num_params = 0;
		class_add_func(IDENTIFIER_FUNC_INIT, TypeVoid, x_p(mf(&Beam::__init__)), Flags::OVERRIDE);
		class_add_func_virtual(IDENTIFIER_FUNC_DELETE, TypeVoid, x_p(mf(&Beam::__delete__)), Flags::OVERRIDE);
		_class_override_num_params = 1;
		class_add_func_virtual("on_iterate", TypeVoid, x_p(mf(&Beam::on_iterate)), Flags::OVERRIDE);
			func_add_param("dt", TypeFloat32);
		_class_override_num_params = -1;
...
/*	add_func("CalcMove",					TypeVoid,		x_p(mf(&Model::CalcMove)));
	...
	add_func("LoadFont",			TypeFontP,	x_p(&__LoadFont), Flags::STATIC);
		func_add_param("filename",		TypeString);
	add_func("LoadModel",												TypeModelP,	x_p(&__LoadModel), Flags::STATIC);
		func_add_param("filename",		TypeString);
/*	add_func("GetModelOID",												TypeInt,	x_p(&MetaGetModelOID), Flags::STATIC);
		func_add_param("filename",		TypeString);*/
	
	// engine
	// game
	add_func("ExitProgram",									TypeVoid,	x_p(ExitProgram), Flags::STATIC);
	add_func("ScreenShot",									TypeVoid,	x_p(ScreenShot), Flags::STATIC);
	add_func("FindHosts",									TypeHostDataList,	x_p(FindHosts), Flags::STATIC);
	add_func("LoadWorld",									TypeVoid,	x_p(LoadWorldSoon), Flags::STATIC);
		func_add_param("filename",		TypeString);
	add_func("LoadGameFromHost",					TypeVoid,	x_p(LoadGameFromHostSoon), Flags::STATIC);
		func_add_param("host",		TypeHostData);
	add_func("SaveGameState",							TypeVoid,	x_p(SaveGameState), Flags::STATIC);
		func_add_param("filename",		TypeString);
	add_func("LoadGameState",							TypeVoid,	x_p(LoadGameStateSoon), Flags::STATIC);
		func_add_param("filename",		TypeString);
	add_func("GetObjectByName",							TypeModelP,	x_p(&GetObjectByName), Flags::STATIC);
		func_add_param("name",		TypeString);
	add_func("FindObjects",								TypeInt,	x_p(&GodFindObjects), Flags::STATIC);
		func_add_param("pos",		TypeVector);
		func_add_param("radius",	TypeFloat32);
		func_add_param("mode",		TypeInt);
		func_add_param("o",			TypeModelPListPs);
	add_func("NextObject",									TypeBool,	x_p(&NextObject), Flags::STATIC);
		func_add_param("o",		TypeModelPPs);
	add_func("CreateObject",							TypeModelP,	x_p(&__CreateObject), Flags::STATIC);
		func_add_param("filename",		TypeString);
		func_add_param("pos",		TypeVector);
	add_func("SplashScreen",					TypeVoid,	x_p(DrawSplashScreen), Flags::STATIC);
		func_add_param("status",		TypeString);
		func_add_param("progress",		TypeFloat32);
	add_func("RenderScene",									TypeVoid, 	nullptr, Flags::STATIC);
	add_func("GetG",											TypeVector,	x_p(&GetG), Flags::STATIC);
		func_add_param("pos",		TypeVector);
	add_func("Trace",											TypeBool,	x_p(&GodTrace), Flags::STATIC);
		func_add_param("p1",		TypeVector);
		func_add_param("p2",		TypeVector);
		...
		// user input
	add_func("UpdateInput",			TypeVoid,	x_p(&update_input), Flags::STATIC);
	add_func("GetKey",								TypeBool,	x_p(&get_key), Flags::STATIC);
		func_add_param("id",		TypeInt);
	add_func("GetKeyDown",								TypeBool,	x_p(&get_key_down), Flags::STATIC);
		func_add_param("id",		TypeInt);
	add_func("GetKeyDownRep",							TypeInt,	x_p(&get_key_down_rep), Flags::STATIC);
	add_func("GetKeyUp",								TypeBool,	x_p(&get_key_up), Flags::STATIC);
		func_add_param("id",		TypeInt);
	add_func("GetKeyChar",							TypeString,	x_p(&get_key_char), Flags::STATIC);
		func_add_param("id",		TypeInt);
	add_func("GetButton",										TypeBool,	x_p(&get_button), Flags::STATIC);
		func_add_param("button",	TypeInt);
	add_func("GetButtonDown",										TypeBool,	x_p(&get_button_down), Flags::STATIC);
		func_add_param("button",	TypeInt);
	add_func("GetButtonUp",										TypeBool,	x_p(&get_button_up), Flags::STATIC);
		func_add_param("button",	TypeInt);
